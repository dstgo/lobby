...
func (e TagEdges) ServersOrErr() (*Server, error) {
	if e.Servers != nil {
...
// QueryServers queries the "servers" edge of the Tag entity.
func (t *Tag) QueryServers() *ServerQuery {
	return NewTagClient(t.config).QueryServers(t)
}
