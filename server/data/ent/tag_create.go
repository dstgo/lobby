...
func (tc *TagCreate) SetOwnerID(i int) *TagCreate {
...
func (tc *TagCreate) SetServers(s *Server) *TagCreate {
	return tc.SetServersID(s.ID)
}
...
// SetOwnerID sets the "owner_id" field.
func (u *TagUpsert) SetOwnerID(v int) *TagUpsert {
...
// SetOwnerID sets the "owner_id" field.
func (u *TagUpsertOne) SetOwnerID(v int) *TagUpsertOne {
	return u.Update(func(s *TagUpsert) {
		s.SetOwnerID(v)
	})
}
...
// SetOwnerID sets the "owner_id" field.
func (u *TagUpsertBulk) SetOwnerID(v int) *TagUpsertBulk {
	return u.Update(func(s *TagUpsert) {
		s.SetOwnerID(v)
	})
}
